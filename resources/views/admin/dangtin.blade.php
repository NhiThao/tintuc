    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div  role="navigation" style="width: 200px;float: left;margin-left: 70px">
            <ul class="list-group panel" style="border: none">
                ...
                <li class="list-group-item" style="color: #23527c"><i class="glyphicon glyphicon-pencil"></i>  QL tài khoản
                ...
                <li class="list-group-item"><a href="calendars.php"><i class="glyphicon glyphicon-envelope"></i>  Thời khóa biểu</a></li>
                        ...
                        <div class="form">
                            <div role="tabpanel" class="tab">
                                <form action="" method="POST">
                                    <h4 style="">Đăng tin tức</h4>

                                    <div style="margin-left: 50px;  margin-top: 20px;"  >
                                        <label for="name" id="">Tiêu đề :</label>
                                        <input class="control" type="text"  placeholder="username"><br>
                                        <label for="choose" id="">Loại :</label>
                                        <select name="choose" id="choose" class="control"">
                                        <optgroup style="background-color: white; color: black">
                                            <option>Chọn loại</option>
                                            <option>Giới thiêu-Giới thiệu chung</option>
                                            <option>Giới thiêu-</option>
                                            <option>Tin tức</option>
                                        </optgroup>
                                        </select><br>

                                        <label> Up file :</label>
                                        <input  type="file" name="fileupload" accept="image/jpeg, image/gif"  style="margin-top: 6px;margin-bottom: -5px;"><br>

                                        <label for="Comment" id="">Nội dung :</label>
