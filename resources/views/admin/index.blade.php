    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div  role="navigation" style="width: 200px;float: left;margin-left: 70px">
            <ul class="list-group panel" style="border: none">
                ...
                <li class="list-group-item" style="color: #23527c"><i class="glyphicon glyphicon-pencil"></i>  QL Giáo viên
                ...
                <li class="list-group-item" style="color: #23527c"><i class="glyphicon glyphicon-bell"></i>  QL Học sinh
                    <ul class="menu-left" style="margin-left: 20px">
                        ...
                        <li style="padding: 5px 20px 0px 10px">
                            <a href="changepass.php" >Cấp lại mật khẩu</a>
                        </li>
                    </ul>

                </li>
                <li class="list-group-item" style="color: #23527c"><i class="glyphicon glyphicon-calendar"></i>  Calendar</a>
                    ...
                    <div class="calendar">
                        ...
                        <div class="days">
                            ...
                            <div class="clearfix" style="font-size: 11px">
                                ...
                                <div class="unit older"><p>29</p></div>
                                <div class="unit older"><p>30</p></div>
                                <div class="unit"><p>1</p></div>
                ...
                <li class="list-group-item" style="color: #23527c;"><a href="calendars.php"><i class="glyphicon glyphicon-envelope"></i>  Hộp thư góp ý</a></li>
