...
<div class="container-fluid">
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div  role="navigation" style="width: 200px;float: left;margin-left: 100px">
                            ...
                            <div role="tabpanel" class="tab">
                                <form action="" class="">
                                    ...
                                    <div style="margin-left: 50px;  margin-top: 20px;"  >
                                        ...
                                        <input class="control" type="text"  placeholder=""><br>
                                        <label for="email" id="">Email :</label>
                                        <input class="control" type="text"  placeholder=""><br>
                                        <label for="password" id="">Password :</label>
                                        <input class="control" type="password"  placeholder=""><br>
                                        <label for="re-password" id="">Re-Password :</label>
                                        <input class="control" type="re-password"  placeholder=""><br>
